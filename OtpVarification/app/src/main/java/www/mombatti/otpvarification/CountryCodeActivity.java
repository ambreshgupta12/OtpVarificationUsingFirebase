...
import www.mombatti.otpvarification.countrycode.CountryCodeAdapter;
...
public class CountryCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utility.hideSoftKeyboard(CountryCodeActivity.this);
        setupUI();
        setUpToolBar();
        setUpDtata();
    }
    ...
    private void setUpToolBar() {
        ...
        mToolBar.setTitleTextColor(ContextCompat.getColor(CountryCodeActivity.this, R.color.white));
    ...
    private void setUpDtata() {
        ...
        CountryCodeAdapter.Callback callback = new CountryCodeAdapter.Callback() {
            ...
            public void onItemCountrySelected(Country country) {
                ...
                Utility.hideKeyBoardFromView(CountryCodeActivity.this);
        ...
        masterCountries.addAll(CountryUtils.getAllCountries(CountryCodeActivity.this));
        ...
        rvCountryCode.setLayoutManager(new LinearLayoutManager(CountryCodeActivity.this));
